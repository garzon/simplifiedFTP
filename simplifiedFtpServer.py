...
def server_handler(s, addr):
    ...
    while True:
        ...
        if cmd == 'put':
            ...
            continue
        if cmd == 'shell' or cmd == 'sh' or cmd == 'bash' or cmd == 'cmd':
...
while True:
    ...
    print 'Connection from %s accepted' % address[0]
    thread.start_new_thread(server_handler, (client_socket, address[0]))